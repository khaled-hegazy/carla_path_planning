...
def game_loop(args):
    ...
    try:
        ...
        # Get All waypoints
        all_waypoints = world.map.generate_waypoints(10)
        ...
        destination = all_waypoints[find_nearest_xy(
            all_waypoints_xy, actor_spawn_loc.x + 10, actor_spawn_loc.y)].transform.location
        ...
        grid_origin_carla = np.array(
            [actor_spawn_loc.x - grid_actor_start_pos[0], actor_spawn_loc.y - grid_actor_start_pos[1]])
        # TODO
        goal_waypoint_location = all_waypoints[find_nearest_xy(
            all_waypoints_xy, actor_spawn_loc.x + grid_width / 2 - 10, actor_spawn_loc.y + grid_height / 2 - 10)].transform.location

        grid_actor_goal_pos = [
            int(round(goal_waypoint_location.x - grid_origin_carla[0])),
            int(round(goal_waypoint_location.y - grid_origin_carla[1]))
        ]
        grid_actor_goal_str = 'x' + \
            str(grid_actor_goal_pos[0]) + 'y' + str(grid_actor_goal_pos[1])

        graph.setStart(grid_actor_start_str)
        graph.setGoal(grid_actor_goal_str)
        ...
        graph, queue, k_m = initDStarLite(
            graph, queue, grid_actor_start_str, grid_actor_goal_str, k_m)
        # --------
